...
slimmedJetsWithUserData = cms.EDProducer("PATJetUserDataEmbedder",
     ...
     userFloats = cms.PSet(
         ...
         chFPV0EF = cms.InputTag("jercVars:chargedEnergyFractionFromPV0"),
         chFPV1EF = cms.InputTag("jercVars:chargedEnergyFractionFromPV1"),
         chFPV2EF = cms.InputTag("jercVars:chargedEnergyFractionFromPV2"),
         chFPV3EF = cms.InputTag("jercVars:chargedEnergyFractionFromPV3"),
         ),
     userInts = cms.PSet(
...
jetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        chFPV0EF = Var("userFloat('chFPV0EF')", float, doc="Charged energy fraction with fromPV==0 (removed by the CHS method), w.r.t. Raw (uncorrected) CHS jet energy. Previously called betastar.", precision= 6),
        chFPV1EF = Var("userFloat('chFPV1EF')", float, doc="Charged energy fraction with fromPV==1 (included by the CHS method), w.r.t. Raw (uncorrected) CHS jet energy.", precision= 6),
        chFPV2EF = Var("userFloat('chFPV2EF')", float, doc="Charged energy fraction with fromPV==2 (included by the CHS method), w.r.t. Raw (uncorrected) CHS jet energy.", precision= 6),
        chFPV3EF = Var("userFloat('chFPV3EF')", float, doc="Charged energy fraction with fromPV==3 (included by the CHS method), w.r.t. Raw (uncorrected) CHS jet energy.", precision= 6),
    )
)
